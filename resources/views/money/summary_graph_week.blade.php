...
<script type="text/javascript" src="/assets/js/summary_graph_week.js"></script>
...
<!-- 週別　購入額 -->
<div id='app_graph_week' style="height:; width:; padding:10px 100px 20px 100px ; ">
    <canvas id='myChart_week'style="background:#eee;"></canvas>
</div>
...
for($x=1;$x<=15;$x++){
	...
	echo "<canvas id='myChart_week".$x."' style='background:#eee;'></canvas>";
	echo '</div>';
}
?>
